...
function ex11(){
    ex11_link = document.getElementById('ex11-link').value
    document.getElementById('ex11-saida').style.backgroundImage = "url("+ex11_link+")"
}
ex12_contador = 0
function ex12(){
    ex12_contador++
    document.getElementById('ex12-saida').innerHTML = ex12_contador
}
...
function ex13(){
    ...
    document.getElementById('ex13-saida').innerHTML =
    "Dia: "+data.getDate()+" ("+dias[data.getDay()]+
    ")<br>Mês: "+meses[data.getMonth()]+
    "<br>Ano: "+data.getFullYear()+
    "<br><br>Horário: "+data.getHours()+":"+data.getMinutes()+":"+data.getSeconds()+":"+data.getMilliseconds()
}
pessoas = []
function ex14(){
    p = {
...
function ex15(){
    pcEscolha = Math.floor(Math.random()*3)
    playerEscolha = document.getElementById('escolha').value
    ex15PlayerEsc()
    ex15Jogo()
}
function ex15PlayerEsc(){
    if(playerEscolha == 0){
        playerEsc = 'Pedra'
    }
    else if(playerEscolha == 1){
        playerEsc = 'Papel'
    }
...
function ex15Jogo(){
    if(playerEscolha == 0){                                                                                                                         // Pedra
        if(pcEscolha == 0){
            document.getElementById('ex15-saida').innerHTML = 'Sua Escolha: '+playerEsc+'<br>Escolha do PC: Pedra<br><br>EMPATE!'
        }
        else if(pcEscolha == 1){
            document.getElementById('ex15-saida').innerHTML = 'Sua Escolha: '+playerEsc+'<br>Escolha do PC: Papel<br><br>VOCÈ PERDEU!'
        }
        else if(pcEscolha == 2){
            document.getElementById('ex15-saida').innerHTML = 'Sua Escolha: '+playerEsc+'<br>Escolha do PC: Tesoura<br><br>VOCÊ GANHOU!'
        }
    }
    else if(playerEscolha == 1){                                                                                                                    // Papel
        if(pcEscolha == 0){
            document.getElementById('ex15-saida').innerHTML = 'Sua Escolha: '+playerEsc+'<br>Escolha do PC: Pedra<br><br>VOCÊ VENCEU!'
        }
        else if(pcEscolha == 1){
            document.getElementById('ex15-saida').innerHTML = 'Sua Escolha: '+playerEsc+'<br>Escolha do PC: Papel<br><br>EMPATE!'
        }
        else if(pcEscolha == 2){
            document.getElementById('ex15-saida').innerHTML = 'Sua Escolha: '+playerEsc+'<br>Escolha do PC: Tesoura<br><br>VOCÊ PERDEU!'
        }
    }
    else if(playerEscolha == 2){                                                                                                                    // Tesoura
        if(pcEscolha == 0){
            document.getElementById('ex15-saida').innerHTML = 'Sua Escolha: '+playerEsc+'<br>Escolha do PC: Pedra<br><br>VOCÊ PERDEU!'
        }
        else if(pcEscolha == 1){
            document.getElementById('ex15-saida').innerHTML = 'Sua Escolha: '+playerEsc+'<br>Escolha do PC: Papel<br><br>VOCÈ GANHOU!'
        }
        else if(pcEscolha == 2){
            document.getElementById('ex15-saida').innerHTML = 'Sua Escolha: '+playerEsc+'<br>Escolha do PC: Tesoura<br><br>EMPATE!'
        }
    }
    else{
        alert('Escolha alguma das opções existentes além da padrão')
    }
}